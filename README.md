...
| DCN | [Wang, R., Fu, B., Fu, G., & Wang, M. (2017). Deep & cross network for ad click predictions. In Proceedings of the ADKDD'17 (pp. 1-7).](https://dl.acm.org/doi/pdf/10.1145/3124749.3124754) | ADKDD | 2017 | [Python](https://paperswithcode.com/paper/deep-cross-network-for-ad-click-predictions) |
